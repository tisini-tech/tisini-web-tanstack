  ...
  head: () => ({
    meta: [
      { title: 'Contact Us | Tisini' },
      {
        name: 'description',
        content:
          "Get in touch with the Tisini team. We'd love to hear from you.",
      },
    ],
  }),
})
...
const contactMethods = [
  {
    label: 'Email',
    value: 'info@tisini.africa',
    href: 'mailto:info@tisini.africa',
  },
  { label: 'Phone', value: '+254 721 724 572', href: 'tel:+254791047878' },
      ...
      <section className="w-full py-20 sm:py-28">
        <div className="grid gap-16 lg:grid-cols-5 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <p className="font-mono text-xs tracking-widest text-pitch dark:text-emerald-400/90">
              GET IN TOUCH
            </p>
            ...
            <p className="mt-6 max-w-sm text-base leading-7 text-muted-foreground">
              A real person reads every message. No ticket queue, no auto-reply
              loop — you'll hear back within a day.
            </p>
